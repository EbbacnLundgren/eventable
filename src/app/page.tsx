    ...
    <div className="relative flex flex-col min-h-screen text-white overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 px-6 sm:px-20 pt-24">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-2xl sm:text-3xl md:text-4xl font-semibold font-sans text-[#1B0D6B] mt-0">
            A seamless way to create, find and explore events. Enjoy!
          </p>
        </div>

        {/* RIGHT SIDE IMAGE */}
        <div className="flex justify-center lg:justify-end w-full lg:w-auto mt-10 lg:mt-4">
          <GlassCard
